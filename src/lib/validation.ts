...
import {
  ...
  FONT_FAMILY_VALUES,
  HOME_SECTION_IDS,
  OUTROS_LAYOUT_VALUES,
  ULTIMAS_LAYOUT_VALUES,
...
export const appearanceSettingsSchema = z.object({
  ...
  outrosLayout: z.enum(OUTROS_LAYOUT_VALUES, "Layout de outros posts inválido."),
  ultimasLayout: z.enum(ULTIMAS_LAYOUT_VALUES, "Layout de últimas inválido."),
});
